        ...
        if (tempType2 === null || tempType2 === "") {
            ...
            return (
                <div className="typeChartMonHolder">
                    <span className="typeChartName">{type1.name}</span><span className="typeChartCell">{tempWeak.normal}</span><span className="typeChartCell">{tempWeak.fighting}</span><span className="typeChartCell">{tempWeak.water}</span><span className="typeChartCell">{tempWeak.fire}</span><span className="typeChartCell">{tempWeak.grass}</span><span className="typeChartCell">{tempWeak.electric}</span><span className="typeChartCell">{tempWeak.dragon}</span><span className="typeChartCell">{tempWeak.fairy}</span><span className="typeChartCell">{tempWeak.steel}</span><span className="typeChartCell">{tempWeak.rock}</span><span className="typeChartCell">{tempWeak.ice}</span><span className="typeChartCell">{tempWeak.ground}</span><span className="typeChartCell">{tempWeak.bug}</span><span className="typeChartCell">{tempWeak.poison}</span><span className="typeChartCell">{tempWeak.psychic}</span><span className="typeChartCell">{tempWeak.dark}</span><span className="typeChartCell">{tempWeak.ghost}</span>
                </div>
